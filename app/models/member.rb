class Member < ApplicationRecord
  ...
  # has_many :inverse_friendships, -> {where status: true}, class_name: "Friendship", foreign_key: "member_id"
  # has_many :inverse_friends, through: :inverse_friendships, source: :member

  has_many :not_accepted_friendships, -> {where status: false}, class_name: "Friendship", foreign_key: "friend_id", dependent: :destroy
